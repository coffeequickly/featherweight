...
- 2.3.1: "Fix: fonts you added are now compressed (about half the space) and every stored font is listed with a usage meter, so fonts added in other files can be deleted."
