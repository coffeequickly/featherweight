...
/**
 * 원본 밖으로 나간 창을 "밖" 이라고 볼 허용치. Figma 는 변환을 float32 로 저장해서, 오른쪽·아래
 * 끝에 딱 붙은 창도 JS 에서는 tx + a = 1.0000000596… 으로 읽힌다 — 끝에 붙은 창 999개 중 332개가
 * 그랬다(2026-09-11). 이 부스러기까지 "밖" 으로 치면 흔한 크롭이 셋에 하나꼴로 기존 경로로 새 나간다.
 */
